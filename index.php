...
<body class="home">
        ...
        <header id="header" class="header-scroll top-header headrom">
            <nav class="navbar navbar-dark">
                <div class="container">
                    ...
                    <a class="navbar-brand" href="index.php"> <img class="img-rounded" src="images/img/60x36.png" alt=""> </a>
                    <div class="collapse navbar-toggleable-md  float-lg-right" id="mainNavbarCollapse">
                        <ul class="nav navbar-nav">
                            <li class="nav-item"> <a class="nav-link active" href="index.php">Inicio <span class="sr-only">(current)</span></a> </li>
                            <li class="nav-item"> <a class="nav-link active" href="Servicios.php">Servicios <span class="sr-only"></span></a> </li>
        ...
        <section class="hero bg-image" data-image-src="images/img/tak.png"> 
            <div class="hero-inner">
                <div class="container text-center hero-text font-white" >
                    <h1> <p style="color:yellow;" >SOLV PRO Servicio de Devoluciones </p> </h1>
                    ...
                    <div class="steps">
                        <div class="step-item step1">
                            ...
                            <h4> <p style="color:yellow;"> 1. Elige la tienda</p></h4> </div>
                
                        <div class="step-item step1">
                            <svg xmlns="http://www.w3.org/2000/svg" width="400" height="512" viewbox="0 0 380.721 380.721">
                                <g fill="#FFF">
                                    
                            </svg>
                            <h4><p style="color:yellow;">2. Elige el producto</p></h4> </div>
              
                        <div class="step-item >
                            <svg xmlns="http://www.w3.org/2000/svg" width="400" height=" 200" viewbox="0 0 612.001 612">
                                
                            <h4><p style="color:yellow;">3. Devolución del producto</p></h4> </div>
...
<div class="container">
                ...
                <div class="title text-xs-center m-b-30">
                    <h2>Como usar SOLV-PRO</h2>
                    <p class="lead">Simplifica las devoluciones</p>
...
<div class="table-wrapper">
                        ...
                        <table class="table">
                                <tr>
                                <td><strong>Encuentra y Reembolsa cualquier producto en cualquier tienda</strong></td>
                                <td><strong>Como Usar el App SOLV-PRO</strong>
                                ...
                                <div>
                                    <select name="select-location" id="select-location">
                                        ...
                                        <option value="-6.77832, -79.83272">platanitos Mall Aventura Chiclayo</option>
                                        <option value="-6.77831, -79.8327">adidas Store Chiclayo, Real Plaza</option>	
                                        <option value="-6.77758, -79.8337">Adidas Originalsr</option>
                                        <option value="-6.76311,-79.86139">adidas Store Chiclayo, Aventura Mall</option>
                                        <option value="-12.0519, -77.10251">SKECHERS MALL PLAZA BELLAVISTA</option>
                                        <option value="-12.07709, -76.97545">adidas Store Lima</option>
                                ...
                                <td>
                                <iframe width="600" height="315" src="https://www.youtube.com/embed/efoyIh2kDfc" title="YouTube video player" 
                frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen float="center">  </iframe> 
        ...
        <section class="popular">
            <div class="container">
                <div class="title text-xs-center m-b-30">
                    ...
                    <p class="lead">Convenio con tiendas a nivel nacional</p>
                </div>
                <div class="row">
						<?php 					
                    ...
                    <div class="row how-it-works-solution">
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col1">
                            <div class="how-it-works-wrap">
                                <div class="step step-1">
                                    ...
                                    <p>Tenemos convenios con tiendas a nivel nacional.</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col2">
                            <div class="step step-2">
                                ...
                                <p>Selecione el tipo de producto a devolver.</p>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col3">
                            <div class="step step-3">
                                ...
                                <h3>Entrega</h3>
                                <p>¡Recibe tu producto a domicilio!  </p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="title-block pull-left">
                            <h4>Servicios que ofrecemos</h4> </div>
                    </div>
                    <div class="col-sm-8">
